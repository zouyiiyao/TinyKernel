...
#define IDT_DESC_CNT 0x81    // 目前总共支持的总中断数
...
static void idt_desc_init(void) {
	...
	// 单独初始化系统调用，系统调用对应的DPL_GATE是3，中断描述符的段选择子DPL_CODE是0，允许用户进程在RING3提升到RING0，有单独的中断处理程序入口syscall_handler
